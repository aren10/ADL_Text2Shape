"""
Shapenet renderer code taken from: https://github.com/panmari/stanford-shapenet-renderer/blob/master/render_blender.py
"""
...
parser.add_argument('--output_folder', type=str, default='./a83cda80e5c5a0fc3719086e0b4ab8be',
                    help='The path the output will be dumped to.')
parser.add_argument('--obj', type=str, default='./a83cda80e5c5a0fc3719086e0b4ab8be/models/model_normalized.obj',
...
#print('_________________hi_______________')
...
fp = os.path.abspath(args.output_folder)

for i in range(0, args.views):
    print("Rotation {}, {}".format((stepsize * i), math.radians(stepsize * i)))

    # render_file_path = fp + '_r_{0:03d}'.format(int(i * stepsize))
    render_file_path = fp + '/{}'.format(int(i))
